...
//    CGRect frame = [self decideTargetFrame:parentView];//parentView.frame;
//    self.frame = CGRectMake(parentView.mj_x, parentView.mj_y, parentView.mj_w, 1);
//    self.frame = CGRectMake(parentView.mj_x, parentView.mj_y, 1, parentView.mj_h);
