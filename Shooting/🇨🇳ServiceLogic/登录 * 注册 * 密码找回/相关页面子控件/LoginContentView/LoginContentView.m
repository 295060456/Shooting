...
-(UIButton *)toRegisterBtn{
    if (!_toRegisterBtn) {
        ...
        [_toRegisterBtn setImage:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",nil, @"用户名称")
              forState:UIControlStateNormal];
        @weakify(self)
...
-(NSMutableArray<UIImage *> *)headerImgMutArr{
    if (!_headerImgMutArr) {
        ...
        [_headerImgMutArr addObject:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",  nil,@"用户名称")];
...
-(UIButton *)storeCodeBtn{
    if (!_storeCodeBtn) {
        ...
        [_storeCodeBtn setTitle:@"记住密码"
                       forState:UIControlStateNormal];
        [_storeCodeBtn setImage:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",nil, @"记住密码")
                       forState:UIControlStateSelected];
        [_storeCodeBtn setImage:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",nil, @"没有记住密码")
                       forState:UIControlStateNormal];
        @weakify(self)
...
-(UIButton *)forgetCodeBtn{
    if (!_forgetCodeBtn) {
        ...
        [_forgetCodeBtn setTitle:@"忘记密码"
                       forState:UIControlStateNormal];
        [_forgetCodeBtn setImage:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",nil, @"KKK")
                       forState:UIControlStateNormal];
        @weakify(self)
