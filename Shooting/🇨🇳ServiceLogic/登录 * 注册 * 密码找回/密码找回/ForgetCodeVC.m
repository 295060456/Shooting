...
-(NSMutableArray<UIImage *> *)backImageMutArr{
    if (!_backImageMutArr) {
        ...
        [_backImageMutArr addObject:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",@"找回密码流程图", @"di_1")];
        [_backImageMutArr addObject:KBuddleIMG(nil, @"登录 * 注册 * 密码找回",@"找回密码流程图", @"di_2")];
        [_backImageMutArr addObject:KBuddleIMG(nil,@"登录 * 注册 * 密码找回",@"找回密码流程图", @"di_3")];
        [_backImageMutArr addObject:KBuddleIMG(nil,@"登录 * 注册 * 密码找回", @"找回密码流程图", @"di_4")];
...
-(UIButton *)successBtn{
    if (!_successBtn) {
        ...
        [_successBtn setImage:KBuddleIMG(nil,@"登录 * 注册 * 密码找回", nil,@"密码修改成功")
                     forState:UIControlStateNormal];
        @weakify(self)
