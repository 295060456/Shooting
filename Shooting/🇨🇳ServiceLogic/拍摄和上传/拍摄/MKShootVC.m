...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithPatternImage:KBuddleIMG(@"拍摄*上传", nil,nil, @"MKShootVC")];
...
-(UIButton *)overturnBtn{
    if (!_overturnBtn) {
        ...
        [_overturnBtn setImage:KBuddleIMG(@"拍摄*上传", nil,nil, @"翻转镜头")
...
-(UIButton *)flashLightBtn{
    if (!_flashLightBtn) {
        ...
        [_flashLightBtn setImage:KBuddleIMG(@"拍摄*上传", nil,@"闪光灯", @"闪光灯-关闭")
                      forState:UIControlStateNormal];
        [_flashLightBtn setImage:KBuddleIMG(@"拍摄*上传",nil,@"闪光灯", @"闪光灯")
...
-(UIButton *)countDownBtn{
    if (!_countDownBtn) {
        ...
        [_countDownBtn setImage:KBuddleIMG(@"拍摄*上传", nil,nil, @"倒计时 关闭状态")
                       forState:UIControlStateNormal];
        [_countDownBtn setImage:KBuddleIMG(@"拍摄*上传", nil,nil, @"倒计时 开启状态")
                       forState:UIControlStateSelected];
        @weakify(self)
...
-(UIButton *)deleteFilmBtn{
    if (!_deleteFilmBtn) {
        ...
        [_deleteFilmBtn setImage:KBuddleIMG(@"拍摄*上传",nil, nil, @"删除视频")
                        forState:UIControlStateNormal];
        @weakify(self)
...
-(UIButton *)sureFilmBtn{
    if (!_sureFilmBtn) {
        ...
        [_sureFilmBtn setImage:KBuddleIMG(@"拍摄*上传",nil, nil, @"保存视频")
                        forState:UIControlStateNormal];
        @weakify(self)
...
-(UIButton *)backBtn{
    if (!_backBtn) {
        ...
        [_backBtn setTitle:@"返回"
                  forState:UIControlStateNormal];
        [_backBtn setImage:KBuddleIMG(@"Others", nil,nil, @"back_white")
                         forState:UIControlStateNormal];
        @weakify(self)
